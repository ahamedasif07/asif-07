...
export default function ProjectCard({ project }) {
  ...
  return (
    <div
      className="relative w-full  max-w-[31.875rem] h-[22.125rem] rounded-lg overflow-hidden shadow-lg transition-transform duration-500 ease-in-out transform hover:scale-105"
